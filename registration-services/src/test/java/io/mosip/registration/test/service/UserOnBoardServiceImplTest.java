...
public class UserOnBoardServiceImplTest {
	...
	public void init() throws Exception {
		...
		appMap.put(RegistrationConstants.SERVER_ACTIVE_PROFILE, "api-internal.techno-associates.live");
		appMap.put(RegistrationConstants.ID_AUTH_DOMAIN_URI, "https://api-internal.techno-associates.live");
		...
		Mockito.when(ApplicationContext.getStringValueFromApplicationMap(RegistrationConstants.SERVER_ACTIVE_PROFILE)).thenReturn("api-internal.techno-associates.live");
	...
	public void userOnBoard() throws HttpClientErrorException, SocketTimeoutException, RegBaseCheckedException, ConnectionException, NoSuchAlgorithmException, CertificateEncodingException, BiometricException {
		Mockito.when(serviceDelegateUtil.prepareURLByHostName(Mockito.anyString())).thenReturn("https://api-internal.techno-associates.live");
