...
public class SoftwareUpdateHandlerTest {
	...
	public void hasUpdateSuccessTest() {
		ReflectionTestUtils.setField(softwareUpdateHandler, "serverMosipXmlFileUrl", "https://api-internal.techno-associates.live/registration-client/maven-metadata.xml");
		...
		Mockito.when(ApplicationContext.getStringValueFromApplicationMap(RegistrationConstants.MOSIP_UPGRADE_SERVER_URL)).thenReturn("https://api-internal.techno-associates.live");
		Mockito.when(serviceDelegateUtil.prepareURLByHostName(Mockito.anyString())).thenReturn("https://api-internal.techno-associates.live/registration-client/maven-metadata.xml");
		Assert.assertFalse(softwareUpdateHandler.hasUpdate());
	}
	...
	public void doSoftwareUpgradeTest() throws Exception {
		...
		ReflectionTestUtils.setField(softwareUpdateHandler, "serverRegClientURL", "https://api-internal.techno-associates.live/registration-client/");
